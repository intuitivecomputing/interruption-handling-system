...
namespace SurvivalExperimental
{
    ...
    public class LLMResponseComponent
    {
        ...
        private static string defaultPromptName = "behavior-generator-survival-luna";
        private static string event1PromptName = "event1-desert-survival";
        private static string event2PromptName = "event2-desert-survival";
        ...
        {
            In = p.CreateReceiver<(string, string, double, bool, double, string, bool, int, string, string)> (this, LLMAPI, nameof(In));
        ...
        public Receiver<(string, string, double, bool, double, string, bool, int, string, string)> In { get; private set; }
        ...
        private void LLMAPI((string, string, double, bool, double, string, bool, int, string, string) componentInput, Envelope envelope)
        {
            ...
            string userUpdatedItemList = componentInput.Item9;
            string itemList = componentInput.Item10;
            ...
            else
            {
                ...
                if (userUpdatedItemList != "")
                {
                    string itemListPrompt = "[User updated list of items on the screen: " + userUpdatedItemList + "]";
                    userSpeechContent = userSpeechContent + itemListPrompt;
                }
                if (taskTime > 280)
                {
