...
function parseMessage(message) {
    const itemMap = {
        ...
        water: '5 liter container of water',
        armyRations: 'case of army rations',
        map: 'maps of the Atlantic Ocean',
        cushion: 'floating seat cushion',
        oil: '10 liter can of oil/petrol mixture',
        radio: 'small transistor radio',
        plasticSheeting: '20 square feet of opaque plastic sheeting',
        sharkRepellent: 'a can of shark repellent',
        rum: 'a bottle of 160 proof rum',
        rope: '15 feet of nylon rope',
        bars: '1 box of chocolate bars',
        fishingKit: 'an ocean fishing kit & pole'
    };
