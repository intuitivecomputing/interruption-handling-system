    ...
    <div className="item-selection">
      {submitted ? (
        <div className="thank-you">
          <h1>Ready to discuss the desert survival simulation task with Luna?</h1>
          <p className='subtitle'>Now you and Luna have 5 minutes to decide on the final list of 7 most important items from the 15 items as a team.</p>
          <p className='subtitle'>Once you are ready, press the "Start timer" button to start the discussion. Press “Submit” when your team reaches an agreement. Please open the door when you are done.</p>
        ...
        <>
          ...
          <p className="instruc">
            Before you discuss with Luna, please select the seven items that you think that are most important for desert survival from the list below. Click on an item to select it and it will be placed in the item list. Click on an item in the item list to remove it. Press the "Done" button when you have selected the items.
          </p>
          {error && (
            <div className="modal">
...
export default DesertInitialItemsPage;
